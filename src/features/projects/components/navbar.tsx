            ...
            <BreadcrumbItem>
              {isRenaming ? (
                <input
                  ...
                  className="cursor-pointer text-sm bg-transparent text-foreground focus:ring-1 focus:ring-inset outline-none focus:ring-ring font-medium max-w-40 truncate p-1 rounded-md"
                />
              ) : (
                <BreadcrumbPage
