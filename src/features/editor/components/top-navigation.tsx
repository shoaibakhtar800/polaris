...
const Tab = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-1.5 h-8.75 p-2 pr-1.5 cursor-pointer text-muted-foreground group/tab border-y border-x border-transparent hover:bg-accent/30",
        isActive &&
    ...
    >
      ...
      <button
        ...
        className={cn(
          "p-0.5 rounded-sm opacity-0 group-hover/tab:opacity-100 close-btn",
